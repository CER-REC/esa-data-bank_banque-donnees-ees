...
The ESA documents includes the analysis of potential effects of constructing and operating the proposed pipeline project on the components of the biophysical and socio-economic environment. These biophysical components are also known as Valued Environmental Components (VECs), whereas socio-economic components are also referred to as Valued Socio-economic Components (VSCs). To extract VECs and VSCs, a list of keywords synonymous to each of the 22 VECs and VSCs, was compiled and a simple keyword search approach was utilized to find the keywords of our interest in the titles extracted (in Step 4 above) and the CSV text in case of tables. For figures and alignment sheets, the VECs and VSCs related keywords were searched in just the titles.
