...
# the order of keywords and the value components are consistent
value_components = [
...
vc_keywords_mapping = dict(zip(value_components, keywords))

# save to a json file
json_file_path = Path(__file__).parent.resolve().joinpath("keywords.json")
with open(json_file_path, "w") as file:
    json.dump(vc_keywords_mapping, file)
